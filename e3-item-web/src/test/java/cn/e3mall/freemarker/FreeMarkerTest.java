...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		//3、设置模板文件保存的目录
		configuration.setDirectoryForTemplateLoading(new File("F:/北大青鸟培训/e3-mall/e3商城_day13/项目二_day13/source/e3-item-web/src/main/webapp/WEB-INF/ftl"));
...
//		Writer out = new FileWriter(new File("D:/temp/JavaEE32/freemarker/hello.txt"));
		Writer out = new FileWriter(new File("F:/北大青鸟培训/e3-mall/e3商城_day13/项目二_day13/source/e3-item-web/src/main/webapp/WEB-INF/ftl/student.html"));
		//8、生成静态页面
